        ...
        <div className="px-10 py-10 ">
          <div className="lg:flex lg:items-center lg:-mx-10">
            ...
            <div className="mt-5 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
              <img className="hidden object-cover mx-auto rounded-full lg:block shrink-0 w-44 h-44" src="https://avatars.githubusercontent.com/u/9476513?v=4" alt="Dipu Singh" />
